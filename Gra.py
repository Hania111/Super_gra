...
from Super_gra.assets.Box import create_box_wall

from settings import WIDTH, HEIGHT, FPS, LIGHT_PISTACHIO, BLACK
from Super_gra.assets.Player import Player
import settings
from Super_gra.assets.Wall import create_walls
from Super_gra.assets.Apple import create_apples
from Super_gra.assets.Button import Button
